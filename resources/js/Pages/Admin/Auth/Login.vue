...
<template>
    ...
    <AuthLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="space-y-4">
                <div>
                    <InputLabel for="login_id" value="Email" />
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <TextInput id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'"
                            autocomplete="current-password" class="mt-1 block w-full" required />
                        <svg @click="togglePassword" class="w-4 h-4 absolute right-4 cursor-pointer dark:text-gray-100"
