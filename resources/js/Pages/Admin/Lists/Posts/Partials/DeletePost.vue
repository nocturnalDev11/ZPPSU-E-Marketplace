...
const deletePost = () => {
    form.delete(route('user-post.destroy', selectedPostId.value), {
        onSuccess: () => {
...
<template>
    <DangerButton @click="confirmDeletePost(props.postId)">
    ...
    <Modal :show="showModal" @close="closeModal">
        <div class="p-6">
            ...
            <div class="mt-4 flex justify-end">
                ...
                <button @click="deletePost" class="px-4 py-2 bg-red-600 text-white rounded">Confirm</button>
            </div>
        </div>
    </Modal>
</template>
