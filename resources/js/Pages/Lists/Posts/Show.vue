...
const form = useForm({
    ...
    content: 'Hi, I noticed you\'re looking for a specific [item/service], and I have exactly what you\'re looking for! Let me know if you\'re interested.',
                    ...
                    <div class="sticky top-0 start-0 py-8 lg:ps-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="shrink-0 relative rounded-lg overflow-hidden size-20">
                                <img v-if="relatedPost.post_picture"
