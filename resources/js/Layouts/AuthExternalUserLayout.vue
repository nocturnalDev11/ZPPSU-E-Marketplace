            ...
            <div class="fixed left-0 right-0 top-0 z-50">
                <nav class="bg-white dark:bg-gray-800">
                        ...
                        <div class="flex h-16 justify-between">
                            <div class="flex">
                                ...
                                <div class="flex shrink-0 items-center me-2">
                                    <Link :href="route('external.home')">
                                    <span class="hidden sm:block w-auto fill-current text-gray-800 dark:text-gray-200">
                                        ZPPSU E-Marketplace
                                    </span>
                                    <ApplicationLogo
                                        class="sm:hidden block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div :class="{
                        ...
                        class="sm:hidden w-72 fixed top-0 left-0 z-40 h-screen xl:p-4 p-2 bg-white dark:bg-gray-800 flex-col justify-start items-start gap-5 border-r border-gray-100 dark:border-gray-700">
                        ...
                        <div class="border-t border-gray-200 pb-2 dark:border-gray-600">
                            <div class="mt-2 space-y-1">
                                ...
                                <ResponsiveNavLink :href="route('external.logout')" method="post" as="button">
            ...
            <aside
                        ...
                        <div class="w-full justify-between items-center inline-flex">
                            <div class="items-center flex">
                                ...
                                <div class="flex-col inline-flex ml-2.5">
                                    ...
                                    <h6 class="text-gray-500 dark:text-gray-300 text-xs font-normal leading-4">
                ...
                <div class="w-full">
                    <div class="w-full h-8 px-3 items-center flex">
                        <h6 class="text-gray-800 dark:text-gray-100 text-xs font-semibold leading-4">MENU</h6>
                    </div>
                ...
                <div class="w-full flex-col flex">
                    ...
                    <ul class="flex-col gap-1 flex">
                        ...
                        <li>
                            <SidebarLink>
                                <div class="h-5 items-center gap-3 flex">
                                    <div class="relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="#6B7280">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <SidebarLink :href="route('external.logout')" method="post" as="button">
                                <div class="h-5 items-center gap-3 flex">
                                    <div class="relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
