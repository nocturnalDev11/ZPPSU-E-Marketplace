        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <div class="fixed left-0 right-0 top-0 z-50">
                <nav class="xl:hidden lg:block md:hidden sm:block bg-white dark:bg-gray-800">
                    ...
                    <div :class="{
                        ...
                        class="xl:hidden w-72 fixed top-0 left-0 z-40 h-screen xl:p-4 p-2 bg-white dark:bg-gray-950 flex-col justify-start items-start gap-5 border-r border-gray-100 dark:border-gray-700">
            ...
            <aside
                ...
                <div class="flex justify-between w-full">
                    <div class="flex xl:w-1/3 w-full flex-shrink">
                        <div class="flex shrink-0 items-center">
                            <Link v-if="$page.props.auth.user.role_id === 1" :href="route('admin.dashboard')">
                            <ApplicationLogo
                                class="flex items-center h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                            </Link>
                ...
                <div class="w-full">
                    ...
                    <ul class="flex-col gap-1 flex">
                        ...
                        <li v-if="$page.props.auth.user.role_id === 2 || $page.props.auth.user.role_id === 3">
                ...
                <div class="w-full flex-col flex">
                    ...
                    <ul class="flex-col gap-1 flex">
                        ...
                        <li>
                            <SidebarLink v-if="$page.props.auth.user.role_id === 1" :href="route('admin.logout')"
